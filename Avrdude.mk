...
AVRDUDE_FLAGS = -v -b $(AVRDUDE_BAUD) -c $(AVRDUDE_PROGRAMMER_ID) -p $(MCU) -P $(AVRDUDE_PORT)
AVRDUDE_FUSE_FLAGS = -U $(AVRDUDE_LOW_FUSE) -U $(AVRDUDE_HIGH_FUSE) -U $(AVRDUDE_EXT_FUSE)
